...
:::::c-card
---
head: 'Ich möchte nicht ständig einen Pony tragen müssen, um meine Stirnfalten zu kaschieren.'
body: 'Stirnfalten sind typische Mimikfalten. Botox reduziert oder beseitigt Stirnfalten schnell und sicher.'
...
:::::c-card
---
head: 'Rechts und links an meiner Nasenwurzel habe ich kleine Fältchen, die mich sehr stören.'
body: 'Botox erzielt nicht nur an den Augen eine exzellente Faltenglättung. Auch die sogenannten Häschenfalten oder Bunny-Lines an der Nase werden schnell geglättet.'
'img-src': 'botox-05.jpg'
'img-alt': 'Junge mit Brille, der sich eine Invisalign Zahnschiene einsetzt'
---
:::::
::::
...
im Gesicht auch zur Reduktion übermäßiger Schweißproduktion unter 
den Achseln und vor allem zur Schmerztherapie bei Problemen 
und Funktionsstörungen im Zusammenhang mit dem Kiefergelenk an. 
...
Der zweite Vorteil: Kaum eine andere Methode der Hautverjüngung hat 
eine so kurze Behandlungsdauer. Die Botox-Spritzen werden gezielt in 
die zu glättenden Hautpartien gesetzt. Dies dauert nur wenige Minuten. 
Zudem ist die Botox-Behandlung nahezu schmerzfrei, da wir für die 
Injektion mit einer hauchdünnen Nadel arbeiten. Erste Ergebnisse 
zeigen sich bereits 2-3 Tage nach der Sitzung. Nach etwa 
5 bis 7 Tagen setzt die vollständige Wirkung der Botox-Injektion 
ein und hält 4 bis 6 Monate an. Da die Anwendung keine bekannten 
...
questions: {
  ...
  answer: {
    part01: 'Wie hoch bei einer Botox-Behandlung die Kosten sind, hängt von der Größe der behandelten Areale, der Anzahl der Injektionen und der Wirkstoffkonzentration ab. In der Regel können Sie mit Preisen zwischen 220 und 500 Euro pro Behandlung rechnen.',
    },
  },
}
---
