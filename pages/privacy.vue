<template>
  <div class="content">
    ...
    <address class="h-card">
      ...
      <p class="p-tel">+49 931 99 147 070</p>
      <p class="u-email">info@praxishugo.de</p>
    </address>
    ...
    <p>
      ...
      <a
        href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_linksnode.html"
      >
        https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_linksnode.html </a
      >.
    </p>
    ...
    <p>
      ...
      gespeichert. Die IPAdresse wird vor der Speicherung anonymisiert.
    </p>
